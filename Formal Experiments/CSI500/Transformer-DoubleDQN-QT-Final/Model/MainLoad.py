...
state_dim = 10
hidden_size = 64
network=Critic_Transformer(state_dim=state_dim,hidden_size=hidden_size,droupout=0.05)
target_network=Critic_Transformer(state_dim=state_dim,hidden_size=hidden_size,droupout=0.05)
ModelType='lstm'
network.load_state_dict(torch.load('ModelParam/2024-3-8/64network-TransformerNoguiadance.pth'))
target_network.load_state_dict(torch.load('ModelParam/2024-3-8/64target-network-TransformerNoguiadance.pth'))
