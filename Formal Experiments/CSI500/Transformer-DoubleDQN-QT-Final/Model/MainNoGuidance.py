...
print(ModelType)
agent = Double_DQN(state_dim=state_dim, hidden_size=hidden_size,ModelType=ModelType,MEMORY_THRESHOLD=8000)
epoch = 7
for k in range(epoch):  # 开的游戏回合
    #print(k)
    env = Env(data_path="Data/15m000905/RESSET_INDXSH2018-2021_000905.csv")
