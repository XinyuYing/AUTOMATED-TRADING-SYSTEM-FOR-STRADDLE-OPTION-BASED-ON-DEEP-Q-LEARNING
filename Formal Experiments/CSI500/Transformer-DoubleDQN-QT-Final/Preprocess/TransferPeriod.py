...
Data=pd.read_csv('Data/B000905/'+file_name)
...
TransferedData.to_csv('./Data/15m000905/'+file_name,index=False)
grouped_data = TransferedData.groupby(TransferedData['time'].dt.date).count()
