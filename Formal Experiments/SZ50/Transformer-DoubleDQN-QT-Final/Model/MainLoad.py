...
ModelType='lstm'
network.load_state_dict(torch.load('ModelParam/2024-2-27/64network-TransformerNoguiadance.pth'))
target_network.load_state_dict(torch.load('ModelParam/2024-2-27/64target-network-TransformerNoguiadance.pth'))
